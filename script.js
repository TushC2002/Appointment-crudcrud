function submitdetails(event){
    ...
    axios.post("https://crudcrud.com/api/1d8d762b999f414786daf95b94ee8285/Appointment",obj)
    .then((response) => {
...
window.addEventListener("DOMContentLoaded",() => {
    axios.get("https://crudcrud.com/api/1d8d762b999f414786daf95b94ee8285/Appointment")
    .then((response) =>{
        console.log(response)
...
function showuseronscreen (obj){
    ...
    deletebutton.onclick = () => {
        axios
          .delete(`https://crudcrud.com/api/1d8d762b999f414786daf95b94ee8285/Appointment/${obj._id}`)
          .then(() => {
    ...
    updatebutton.onclick = () => {
      axios
        .put(`https://crudcrud.com/api/1d8d762b999f414786daf95b94ee8285/Appointment/${obj._id}`, {
